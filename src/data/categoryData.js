...
export const CATEGORY_DATA = [
  { id: 'medicines', name: 'Medicines', label: 'Medicines', icon: Pill, subcategories: ['Derma', 'Gastro-Intestinal Tract','Pain Relief','Circulatory System', 'Others', ,'Endocrine System', 'Eyes, Nose, Ear', 'Urinary Tract System', 'Central Nervous System', 'Respiratory Tract System', 'Cardio-Vascular System', 'Oral Care'] },
