...
export default function MedicineDetailModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-[#f4f8f8] overflow-y-auto animate-in fade-in duration-200">
      ...
      {/* ============ MAIN CONTENT ============ */}
      <main className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 py-5 sm:py-6 pb-12">
        ...
        {/* RATINGS & REVIEWS */}
        <div className="rounded-2xl sm:rounded-3xl border border-slate-200 bg-white p-5 sm:p-6 space-y-5 shadow-sm mb-10">
          <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-slate-100">
            <div className="flex items-center gap-2">
              <MessageSquarePlus className="h-5 w-5 text-teal-600" />
              <h4 className="text-sm font-black uppercase tracking-wider text-slate-800">Ratings & Reviews</h4>
        ...
        <div className="mt-8 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-[10px] font-black uppercase tracking-wider text-teal-700">Explore More</p>
              <h3 className="text-lg sm:text-xl font-black text-slate-900">
                Related Products in {medicine.category || 'Category'}
              </h3>
            </div>
          </div>
          ...
          {relatedLoading ? (
            ...
            <p className="text-xs text-slate-400">No related products found in this category.</p>
          )}
        </div>
