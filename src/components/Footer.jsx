        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12 pb-8 sm:pb-12 border-b border-slate-300 items-start">
          ...
          <div className="flex flex-col gap-3.5 sm:gap-4">
            ...
            <div className="flex items-center gap-3">
              <img 
                src={logoImg} 
                alt="MediCure Pharmacy Logo" 
                className="h-10 w-auto object-contain mix-blend-multiply rounded-md" 
              />
              <div className="flex items-baseline text-xl font-bold tracking-tight">
                <span className="text-slate-900">Medi</span>
                <span className="text-teal-600">Cure</span>
            ...
            <ul className="space-y-2.5 text-sm font-medium">
              <li>
                <button 
                  ...
                  className="text-teal-600 hover:text-teal-700 hover:underline transition-all flex items-center gap-1 font-semibold"
                >
              ...
              <li>
                <button 
                  ...
                  className="text-teal-600 hover:text-teal-700 hover:underline transition-all flex items-center gap-1 font-semibold"
                >
                  <span className="text-teal-500">›</span> Privacy Policy
                </button>
              </li>
              <li>
                <button 
                  ...
                  className="text-teal-600 hover:text-teal-700 hover:underline transition-all flex items-center gap-1 font-semibold"
                >
                  <span className="text-teal-500">›</span> Terms of Service
                </button>
              </li>
            </ul>
          </div>
